      ...
      <el-table :data="tableData" style="width: 100%; margin-top: 20px;" v-loading="loading">
        ...
        <el-table-column prop="type" label="类型" width="120">
          <template #default="{ row }">
            <el-tag v-if="row.type === 'SYSTEM'">系统通知</el-tag>
            <el-tag v-else-if="row.type === 'POLICY'" type="warning">政策变动</el-tag>
            <el-tag v-else-if="row.type === 'ANNOUNCEMENT'" type="success">公告提醒</el-tag>
          </template>
        </el-table-column>
...
import { getNoticeList, deleteNotice, publishNotice } from '@/api/notice'
