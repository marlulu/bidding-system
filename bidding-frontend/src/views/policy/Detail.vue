    ...
    <el-card v-loading="loading">
      ...
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="分类">
          <el-tag v-if="detail.category === 'POLICY'">政策</el-tag>
          <el-tag v-else-if="detail.category === 'REGULATION'" type="warning">法规</el-tag>
          <el-tag v-else-if="detail.category === 'GUIDE'" type="success">指南</el-tag>
...
const loadData = async () => {
  loading.value = true
  try {
    detail.value = await getPolicyById(route.params.id)
  } catch (error) {
